...
void SetupMiscCat(MWindow* MainWindow)
{
	...
	MiscElements.Misc_Chat_ClanTagChanger = new MDropdown(MiscElements.Misc_General, XorStr("clan tag changer"), XorStr("Changes your clantag"), MiscElements.MiscCat, XorStr("misc_general_clantagchanger"), std::vector<string>{"off", "syhpware"});
...
CMenu::CMenu()
{
	...
	MainWindow = new MWindow(XorStr("syhpware"), Vector(500, 500), Vector(600, 400), true);
